...
def cog(pilot_1, pilot_2, coordinator, observer_1L, observer_1R, observer_2L, observer_2R, observer_3L, observer_3R, BEM, M_fuel_function, W_fuel_t):
    ...
    M_BEM = BEM[0] * BEM[1]
    X_cog_datum = (M_pilot_1 + M_pilot_2 + M_coordinator + M_observer_1L + M_observer_1R + M_observer_2L + M_observer_2R + M_observer_3L + M_observer_3R + M_BEM + M_fuel_function(W_fuel_t))/(pilot_1[0] + pilot_2[0] + coordinator[0] + observer_1L[0] + observer_1R[0] + observer_2L[0] + observer_2R[0] + observer_3L[0] + observer_3R[0] + BEM[0] + (W_fuel_t*0.45359237))
    return X_cog_datum #Center of gravity at time t

print cog(pilot_1, pilot_2, coordinator, observer_1L, observer_1R, observer_2L, observer_2R, observer_3L, observer_3R, BEM, M_fuel_function, 4000)