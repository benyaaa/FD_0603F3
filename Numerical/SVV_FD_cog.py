...
#Needs numerical input for fuel weight at time t in kg and for Tim integer 1 or 2
#returns cog[0] and cog[1]
def cog(pilot_1, pilot_2, coordinator, observer_1L, observer_1R, observer_2L, observer_2R, observer_3L, observer_3R, BEM, M_fuel_function, W_fuel_t, Tim):
    ...
    M_observer_3R = observer_3R[0] * observer_3R[Tim]
    M_BEM = BEM[0] * BEM[1]
    W_total_t = pilot_1[0] + pilot_2[0] + coordinator[0] + observer_1L[0] + observer_1R[0] + observer_2L[0] + observer_2R[0] + observer_3L[0] + observer_3R[0] + BEM[0] + (W_fuel_t)
